// 3 - Adicione o campo avaliacao em todos os documentos da coleção e
// efetue alterações nesse campo.
...
//  sanduíches de carne do tipo bovino. Dica: utilize como filtro o campo tags.
db.produtos.updateMany({ tags: "bovino" }, { $set: { avaliacao: NumberInt(5) } });

// Crie uma query que incremente o valor do campo avaliacao em 3 em todos os 
// sanduíches de ave.
